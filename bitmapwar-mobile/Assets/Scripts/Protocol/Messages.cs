    ...
    public static void Parse(string data)
    {
        ...
        switch (msg.method)
        {
            ...
            case "GetLeaderBoardSuccess":
                ...
                if (TotalProfitPanel.inst.isOpen)
                {
                    TotalProfitPanel.inst.OnData(glbs);
                }
                    
                
                break;
            case "GetUserHistoricalBenefitSuccess":
                Debug.Log("Get History Benefist:" + data);

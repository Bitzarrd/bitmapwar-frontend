...
public class MainPage : MonoBehaviour
{
    ...
    public GameObject popRankingPanel;
    public GameObject profitList;
    ...
    */
    ...
    private void ComposeChatBubble()
    {
        /*
    ...
    private void init()
    {
        ...
        CloseMenu.onClick.AddListener(() => topMenu.SetActive(false));
    }
    ...
    {
        //var tl = view.GetChild("n162").asTextField;
        //tl.SetVar("count", Consts.IntToAbrevMode(lands)).FlushVars();
    }
    ...
    public void SetDurationTime(long seconds)
    {
        ...
        DurationText.text = timeFormatted;
        /*
    ...
    */
    ...
    public void UpdateNextRoundTimer(int sec)
    {
        ...
        // 格式化时间
        string timeFormatted = string.Format("{0:D2}:{1:D2}", time.Minutes, time.Seconds);
        nextRoundText.text = timeFormatted;
        /*
    ...
    {
        totalBonusText.text = Consts.StrToDouble(jackpot);
        //TotalBonus.text = Consts.StrToDouble(jackpot);
    }

    public void UpdateJackPot(string jackpot)
    {
        jackpotText.text = Consts.StrToDouble(jackpot);
    ...
    private void makePage()
    {
        ...
        () =>
        {
            ...
            #else
            Toast.Inst.Open("This function is not available yet, please wait for the official announcement.");
            #endif
        });
    ...
    {
        var cn = Consts.colorNameIndex[s.team];
        Text landTxt = staticInfo[cn * 3];
        Text soldierTxt = staticInfo[cn * 3 + 1];
        Text lostStr = staticInfo[cn * 3 + 2];
        landTxt.text = s.land.ToString();
        soldierTxt.text = s.virus.ToString();
        lostStr.text = s.loss.ToString();

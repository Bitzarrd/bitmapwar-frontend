...
public class ProtoUtils
{
    ...
    public static void SendLogin(string wallet = "02b13a59a27e6268117b1abc19f1b147f56bb65f89136ec574457a7466401d6652", string message = "", string sig = "")
    {
        var msg = new Login()
        {
            method = "Login",
    ...
    public static void Parse(string data)
    {
        ...
        switch (msg.method)
        {
            ...
            case "Update":
                ...
                //1350325 Length
                Debug.Log("Update:" + update.payload.Length);
                ParseUpdate(update);
                break;
            case "LoginSuccess":
            ...
            case "UpdateExtractSuccess":
                Debug.Log("Update Extract Success" + data);
            ...
            case "JackpotLightUpWithoutPlayers":
                ...
                break;
            case "GetExtractPurchaseLogSuccess":
                Debug.Log("Extract Purchase Log Success: " + data);
                var gepls = JsonConvert.DeserializeObject<GetExtractPurchaseLogSuccess>(data);
                if (ExtractProfitPage.Inst.isOpen)
                {
                    ExtractProfitPage.Inst.UpdateItem(gepls);
                }
                break;
            default:
...
{
    public ExtractsLog[] extract_log;// | 提取记录  |
    public PurchaseLog[] purchases_log;// | 充值记录  |
}
